...
// .format('MMM D, YYYY ' + ' at ' + ' HH:mm:ss a'));
...
// 2. Create a Bootstrap card component explaining the instructions of how to use the app 
// and a button to open a [Bootstrap modal dialog](https://getbootstrap.com/docs/5.1/components/modal/).
...
var myModal = document.getElementById('new-project-modal')
